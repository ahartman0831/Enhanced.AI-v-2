    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-gradient-to-br from-primary/5 via-background to-secondary/5">
        <div className="container mx-auto px-4 py-16 sm:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Hero Disclaimer */}
            <Alert className="max-w-2xl mx-auto border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          {/* Final Disclaimer */}
          <Alert className="max-w-3xl mx-auto border-destructive/50 bg-destructive/5">
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription className="text-sm">
          ...
          <div className="mt-8 text-sm text-muted-foreground">
            <p>© 2024 Enhanced.AI. Educational information only. Not medical advice.</p>
          </div>
        </div>
      </section>
    </div>
